		...
		<section className=" bg-gray-200 text-gray-800">
			<div className="container flex flex-col items-center mx-auto md:p-10 md:px-12">
				<h1 className="text-4xl font-semibold leading-none text-center">
					What our students are saying about us <br />
					OR <br />
					Quotes by some famous Shotokan people
				</h1>
			</div>
			<div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
				<div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
					...
					<div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-red-600 text-gray-50">
						<img
