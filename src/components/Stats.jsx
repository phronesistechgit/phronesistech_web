...
const Stats = () => {
	return (
		<section className="p-4 md:p-8 bg-gray-200 text-gray-800">
			...
			<div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
				<div className="flex overflow-hidden rounded-lg bg-gray-50 text-gray-800">
					<div className="flex items-center justify-center px-4 bg-red-600 text-gray-800">
						<svg
				...
				<div className="flex overflow-hidden rounded-lg bg-gray-50 text-gray-800">
					...
					<div className="flex items-center justify-between flex-1 p-3">
						<p className="text-2xl font-semibold">7 days a week</p>
				...
				<div className="flex overflow-hidden rounded-lg bg-gray-50 text-gray-800">
					...
					<div className="flex items-center justify-between flex-1 p-3">
						...
						<p>Locations across multiple Cities</p>
					</div>
				</div>
				<div className="flex overflow-hidden rounded-lg bg-gray-50 text-gray-800">
					<div className="flex items-center justify-center px-4 bg-red-600 text-gray-800">
