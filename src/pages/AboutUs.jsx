    ...
    >
      ...
      <div className="max-w-6xl p-6 mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex flex-col gap-6 md:w-1/2 text-lg text-gray-900">
          <p className="text-justify leading-relaxed">
            <span className="font-extrabold text-blue-700">PhronesisTech</span>{" "}
            is a dynamic company founded in 2022, offering innovative IT
            solutions, consulting, project, and product management services.
            With a dual presence in Boston (USA) and Bangalore (India), we bring
            a global perspective to every project we undertake, ensuring the
          ...
          <p className="text-justify leading-relaxed">
            ...
            potential. Leading change requires courage, innovation, focus, and
      ...
      <div className="max-w-6xl p-6 mx-auto flex flex-col md:flex-row justify-between items-center gap-10 mt-12">
        ...
        <div className="text-center bg-white p-8 rounded-xl shadow-lg w-full md:w-1/2 border-t-4 border-blue-700 transform hover:scale-105 transition duration-500">
          ...
          <p className="text-gray-800 leading-relaxed text-center">
            Our vision is to be the leading provider of exceptional service
            solutions, recognized for our commitment to excellence, innovation,
